...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/manager/shenhemanager" method="post">
		<input type="hidden" name="manger.idString" value="${param.idString}" id="idString"/>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3">审核操作：</label>
			<div class="formControls col-xs-4 col-sm-4"> 
				<span class="select-box">
					<select class="select" name="typeInt.checkedStatusInt" size="1">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="manager.reasonString" cols="" id="tagency_reasonString" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)"></textarea>
