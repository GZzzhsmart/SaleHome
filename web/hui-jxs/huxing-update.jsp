	...
	<form class="form form-horizontal" onsubmit="return checkvolid();" enctype="multipart/form-data" id="form-admin-add" action="<%=path%>/hx/updatesave" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${house.nameString}" onblur="checkname(this.value);" placeholder="请输入户型名称" id="house_nameString" name="house.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" style="width:26.5em" autocomplete="off" value="${house.areaDouble}" placeholder="请输入户型总层数" onblur="checktotal(this.value);" id="house_areaDouble" name="house.areaDouble">
