...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" id="form-article-add" method="post" action="<%=path%>/manager/updasavetearticle">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${article.titleString}" placeholder="请输入文章标题" id="article_titleString" name="article.titleString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${article.publicusernameString}" placeholder="请输入文章作者" id="article_publicusernameString" name="article.publicusernameString">
			</div>
		</div>
		<div class="row cl">
