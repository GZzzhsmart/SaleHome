							...
							<div class="tab-pane fade in active" id="login">
								<form class="form-horizontal"  role="form" id="form" onsubmit="pwd();" action="<%=path %>/lr/loginsuccess">
				                      ...
				                      <div class="form-group help">
				                          ...
				                          <button class="btn btn-primary btn-lg fa-question-circle glyphicon glyphicon-info-sign" style="margin-top:0px"><a href="<%=path%>/hui-jxs/findloginpwd.jsp">忘记密码</a></button>
				                      </div>
				                      <div class="form-group">
