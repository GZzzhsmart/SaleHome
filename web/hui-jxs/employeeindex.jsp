					...
					<ul class="cl">
						<li class="dropDown dropDown_hover"><a href="javascript:;"
							...
							<ul class="dropDown-menu menu radius box-shadow">
								<li>
									<a style="cursor: pointer;text-decoration: none;" class="text-primary" onclick="info_edit('${employee.nameString}员工资料详情','<%=path%>/yg/showemployee?employee.idString=${employee.idString}','${employee.idString}','600','480')"><i class="Hui-iconfont">&#xe62d;</i>${employee.nameString}</a>
								</li>
								<li>
