...
<div class="page-container">
	<form class="form form-horizontal" onsubmit="return checkimg();" id="form-article-add" method="post" action="<%=path%>/lpimg/addloupanimg">
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3">楼盘名称：</label>
			<div class="formControls col-xs-4 col-sm-4"> 
				<span class="select-box">
					<select class="select" name="img.buildingsIdString"  id="imgid" onchange="getld(this.value);" id="house_buildingsId" size="1">
						<option value="-1">请选择楼盘名称</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-5 col-sm-2">${param.nameString}楼盘图片上传：</label>
