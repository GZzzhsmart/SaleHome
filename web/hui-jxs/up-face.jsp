...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/user/upface" method="post">
		<input type="hidden" name="user.idString" value="${user.idString}" />
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">原头像：</label>
			<div class="formControls col-xs-8 col-sm-9">
					<img src="<%=path%>/${user.logoString}" style="width:200px;height:200px;border-radius:100%"/>
			</div>
		</div>
		<div class="row cl">
