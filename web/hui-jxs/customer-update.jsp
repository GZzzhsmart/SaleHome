...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=path%>/customer/updatecustomer" method="post" enctype="multipart/form-data">
		<input type="hidden" name="customer.idString" value="${param.idString}"/>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2">购房合同：</label>
			<div class="formControls col-xs-3 col-sm-4"> <span class="btn-upload form-group">
				<input class="input-text" type="text" value="" name="" readonly  style="width:200px">
		...
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2">电子版档案：</label>
			<div class="formControls col-xs-3 col-sm-4"> <span class="btn-upload form-group">
				<input class="input-text" type="text" value="" name="" readonly  style="width:200px">
				<a href="javascript:void();" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 确认客户购房</button>
