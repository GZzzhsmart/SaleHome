	...
	<div class="header">
		<div class="top_main">
			...
			<div class="top_right">
				...
				<span><img alt="赣州房产平台客服:15679760329"
		...
		<div class="tab">
			<div class="tab_box">
				<ul class="home_bt">
					...
					<li id="child_23"><a
						href="<%=path%>/facemain/bestloupan">推荐楼盘</a></li>
				...
				<div class="cat_content">
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">1.意向房屋确定</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">a.确定购房目的、意向投资资金、意向投资区域、意向房产类型、意向购买时间。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">b.桃源盛景销售平台根据客户的意向提供专业意见以及相关的投资报告和楼市趋势资料。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">c.
							桃源盛景销售平台进行区位锁定，搜集符合客户需求的房子并提供房屋相关信息直到客户选定满意的房子。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">d.
							如需进行贷款，先进行免费的贷款评估及相关后期资料准备。</span>
					</p>
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">2.签订咨询服务协议</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">在签订咨询服务协议之前，桃源盛景销售平台向客户确定是否需要实地看房。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">a.
							如需实地看房，签订房屋考察协议，桃源盛景销售平台协助办理签证及制定相关行程，安排实地看房，中国当地平台工作人员陪同接待。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">b.
							如无需实地看房，客户在确定购买意向后在国内签订咨询服务协议。</span>
					</p>
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">3.进行房屋价格商议</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">a.
							桃源盛景销售平台马上联系房屋拥有者以及中国本地中介，平台伦敦工作人员对房屋进行的考察。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">b.
							桃源盛景销售平台提供全面的房产信息（中英文版皆可），房型图，介绍资料以及一切与选定房产相关的信息。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">c.
							进行房屋价格协商，此阶段平台会全力站在客户的角度进行最大力度的议价。如果最后房屋没有谈判成功，平台会为客户重新进行房产搜寻工作。</span>
					</p>
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">4.签订购房合同</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">a.客户提供购房所需的材料。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">b.桃源盛景销售平台安排客户选择律师，签订律师委托协议。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">c.客户在律师/经纪人的指导下签定购房合同,律师准备房屋调查报告。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">d.
							签订购房合同并缴纳10%房屋首付款，桃源盛景销售平台协助办理跨国转账等。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">e.
							如客户需贷款，桃源盛景销售平台协助客户准备贷款所需的材料，交房前3-6个月提交贷款申请。</span>
					</p>
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">5.付款选择</span></strong>
					</p>
					<p style="line-height: 3em;">
					...
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">6.确认验收</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">a.桃源盛景销售平台通知客户收房，并协助客户支付尾款及其他费用。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">b.向卖方律师支付购房款的余款并缴纳印花税等费用，完成产权证书和房屋钥匙的移交工作。</span>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">c.
							买方律师做最后一道工序：申请土地所有权登记。完成登记之后，大约一周时间土地登记部门出具土地证书，确认买方现为房产所有人。</span>
					</p>
					<p style="line-height: 3em;">
						<strong><span
							style="font-size: 20px; color: #FFFFFF; background-color: #262626;">7.售后服务</span></strong>
					</p>
					<p style="line-height: 3em;">
						<span style="font-size: 18px;">桃源盛景销售平台为客户安排安家、物业管理、法务、税务等后续服务。</span>
					</p>
					<p style="line-height: 3em;">
						<br />
					</p>
