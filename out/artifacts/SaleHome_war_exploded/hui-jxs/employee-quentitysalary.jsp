		...
		<table
			...
			<tbody id="pageBody">
				<s:iterator var="l" value="#request.userprizelist">
					<tr class="text-c">
						<td>
							<a style="cursor: pointer;text-decoration: none;" class="text-primary" onclick="loupan_edit('${l.user.nameString}用户详情','<%=path%>/user/showuser?user.idString=${l.userIdString}','${l.user.nameString}','','430')">${l.user.nameString}</a>
						</td>
						<td>
							${l.prize}
						</td>
