	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				<a href="javascript:;" onclick="article_add('添加文章','<%=path%>/manager/initaddarticle','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a>
					...
					<tr class="text-c">
						...
						<c:if test="${l.statusInt==0}">
							...
							<td class="td-manage">
								...
								<a title="编辑文章" href="javascript:;"	onclick="article_edit('${l.titleString}文章的修改','<%=path%>/manager/initupdatearticle?article.idString=${l.idString}','${l.titleString}','','460')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
<script type="text/javascript">
		...
		function checkpage(index){
			window.location.href='${pageContext.request.contextPath}/manager/pagearticle?currentpage='+index;
		}
		/*文章-刷新*/
		function refresh(){
			window.location.href='${pageContext.request.contextPath}/manager/pagearticle';
			layer.msg('刷新成功!', {
				icon : 1,
				time : 2000
			});
		...
		function datadel(){
			...
			window.location.href='${pageContext.request.contextPath}/manager/deletemanyarticle?id='+a;
			layer.msg('删除成功!', {
				icon : 1,
				time : 2000
			});
		...
		function article_del(obj, id) {
			...
			$.ajax({
					type : 'POST',
					url : '${pageContext.request.contextPath}/manager/deletearticle?article.idString='+ id,
					dataType : 'text',
...
// 			layer.full(index);
		...
		function article_stop(obj, id) {
			layer.confirm('确认禁用吗？',function(index) {
				...
				$.post(
					"${pageContext.request.contextPath}/manager/updatearticlestatus",
					{
						"article.idString" : id,
						"article.statusInt" : 1
					},
		...
		function article_start(obj, id) {
			...
			function(index) {
				...
				$.post("${pageContext.request.contextPath}/manager/updatearticlestatus",
				{
					"article.idString" : id,
					"article.statusInt" : 0
				}, function(data) {
